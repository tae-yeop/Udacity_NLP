...
def cnn_output_length(input_length, filter_size, border_mode, stride,
    ...
    print((output_length + stride - 1) // stride)
...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for i in range(recur_layers):
        if i==0:
            rnn = GRU(units, activation='relu',return_sequences=True, implementation=2)(input_data)
        else:
            rnn = GRU(units, activation='relu',return_sequences=True, implementation=2)(rnn)
